			...
			<div class="furniture-container homepage-container">
								...
								<div class="row">
									<div class="col-md-6 col-sm-4 col-lg-4">
										<div class="info-box">
											<div class="row">
												...
												<div class="col-xs-10">
													<h4 class="info-box-heading stu">money back</h4>
												</div>
											</div>
											<h6 class="text" id="student2618359">30 Day Money Back Guarantee.</h6>
										</div>
									</div><!-- .col -->
									...
									<div class="hidden-md col-sm-4 col-lg-4">
										<div class="info-box">
											...
											<h6 class="text" id="student2618359">free ship-on oder over £ 600.00</h6>
										</div>
									</div><!-- .col -->
									...
									<div class="col-md-6 col-sm-4 col-lg-4">
										<div class="info-box">
											...
											<h6 class="text" id="student2618359">Discounted prices on selected items, with savings of up to 30%
				...
				<div id="product-tabs-slider" class="scroll-tabs inner-bottom-vs wow fadeInUp">
					<div class="more-info-tab clearfix">
						<h3 class="new-product-title pull-left student">Featured Products</h3>
					...
					<div class="row">
						<div class="col-md-6">
							<section class="section">
								<h3 class="section-title student">Routers & Locks</h3>
								<div class="owl-carousel homepage-owl-carousel custom-carousel outer-top-xs owl-theme" data-item="2">

									<?php
									$ret = mysqli_query($con, "select * from products where category=14");
									while ($row = mysqli_fetch_array($ret)) {
									?>
						...
						<div class="col-md-6">
							<section class="section">
								<h3 class="section-title student">Projectors</h3>
								<div class="owl-carousel homepage-owl-carousel custom-carousel outer-top-xs owl-theme" data-item="2">
									<?php
									$ret = mysqli_query($con, "select * from products where category=13 and subCategory=22");
									while ($row = mysqli_fetch_array($ret)) {
									?>
				...
				<section class="section featured-product inner-xs wow fadeInUp">
					<h3 class="section-title">AirPods</h3>
