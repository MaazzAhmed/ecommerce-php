...
if (isset($_GET['pid']) && $_GET['action'] == "wishlist") {
	if (strlen($_SESSION['login']) == 0) {
		...
		mysqli_query($mysqli,"insert into wishlist(userId,productId) values('" . $_SESSION['id'] . "','" . $_GET['pid'] . "')");
						...
						<div class="sidebar-filter">
							...
							<div class="sidebar-widget wow fadeInUp outer-bottom-xs ">
								...
								<div class="sidebar-widget-body m-t-10">
									<?php $sql = mysqli_query($mysqli, "select id,categoryName from category");
						...
						<div class="item">
							...
							<div class="container-fluid">
								<div class="caption vertical-top text-left">
									...
									<?php $sql = mysqli_query($mysqli,"select  subcategory  from  subcategory where id='$cid'");
									while ($row = mysqli_fetch_array($sql)) {
									?>
						...
						<div id="myTabContent" class="tab-content">
							<div class="tab-pane active " id="grid-container">
								<div class="category-product  inner-top-vs">
									<div class="row">
										<?php
										$ret = mysqli_query($mysqli,"select * from products where subCategory='$cid'");
										$cnt = 0;
